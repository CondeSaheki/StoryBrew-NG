    ...
    private static readonly List<ObjectSerializer> serializers = new List<ObjectSerializer>()
        {
            ...
            new SimpleObjectSerializer<bool>(r => r.ReadBoolean(), (w, v) => w.Write((bool)v), v => bool.Parse(v), v => v.ToString() ?? throw new Exception()),
...
internal  class SimpleObjectSerializer<T> : ObjectSerializer
{
