using StoryBrew.Common.Animations;
...
{
    private OsbSprite spriteBody = new();
    private OsbSprite spriteTopEdge = new();
    private OsbSprite spriteBottomEdge = new();
    private OsbSprite spriteStartCap = new();
    private OsbSprite spriteEndCapEnd = new();
    ...
    public string SpritePathBody = string.Empty;
    public string SpritePathEdge = string.Empty;
    public string SpritePathCap = string.Empty;
    ...
    public override void GenerateStates(double time, CameraState cameraState, Object3dState object3dState)
    {
        ...
        var bitmapBody = StoryboardObjectGenerator.Current?.GetMapsetBitmap(spriteBody.GetTexturePathAt(time)) ?? throw new Exception();
