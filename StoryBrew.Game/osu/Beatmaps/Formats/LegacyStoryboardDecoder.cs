...
using osu.Game.StoryboardsNG.Commands;
...
{
    public class LegacyStoryboardDecoderRE : LegacyDecoder<Storyboard>
    {
        ...
        public LegacyStoryboardDecoderRE(int version = LATEST_VERSION)
            : base(version)
        {
        }
        ...
        public static void Register()
        {
            ...
            AddDecoder<Storyboard>(@"osu file format v", m => new LegacyStoryboardDecoderRE(Parsing.ParseInt(m.Split('v').Last())));
            AddDecoder<Storyboard>(@"[Events]", _ => new LegacyStoryboardDecoderRE());
            SetFallbackDecoder<Storyboard>(() => new LegacyStoryboardDecoderRE());
        }
