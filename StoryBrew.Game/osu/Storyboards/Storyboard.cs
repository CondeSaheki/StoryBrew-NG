...
using osu.Game.StoryboardsNG.Drawables;
using osu.Game.Utils;

namespace osu.Game.StoryboardsNG
{
    public class Storyboard
    {
        ...
        public virtual DrawableStoryboard CreateDrawable(string mapsetPath, IReadOnlyList<Mod>? mods = null) =>
            new DrawableStoryboard(this, mapsetPath, mods);
