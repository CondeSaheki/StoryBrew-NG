...
public class EditorStoryboardSegment : StoryboardSegment, DisplayableObject, HasPostProcess
{
    ...
    private readonly List<StoryboardObject> storyboardObjects = [];
    private readonly List<DisplayableObject> displayableObjects = [];
    private readonly List<EventObject> eventObjects = [];
    private readonly List<EditorStoryboardSegment> segments = [];
    ...
    private StoryboardSegment getSegment(string? identifier = null)
    {
        ...
        if (identifier == null || !namedSegments.TryGetValue(identifier, out var segment))
        {
            ...
            if (identifier != null) namedSegments.Add(identifier, segment);
        }
        return segment;
    }
