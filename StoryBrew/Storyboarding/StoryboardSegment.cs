...
public abstract class StoryboardSegment : IStoryboardElement
{
    ...
    public abstract Sprite CreateSprite(string path, Origin origin, Vector2 initialPosition);
    public abstract Sprite CreateSprite(string path, Origin origin = Storyboarding.Origin.Centre);

    public abstract Animation CreateAnimation(string path, int frameCount, double frameDelay, LoopType loopType, Origin origin, Vector2 initialPosition);
    public abstract Animation CreateAnimation(string path, int frameCount, double frameDelay, LoopType loopType, Origin origin = Storyboarding.Origin.Centre);

    public abstract Sample CreateSample(string path, double time, double volume = 100);

    public abstract void Discard(IStoryboardElement storyboardObject);
